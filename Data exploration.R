...
#          last_day_rch_amt_6 = as.POSIXct(mdy(last_day_rch_amt_6)),
#          last_day_rch_amt_7 = as.POSIXct(mdy(last_day_rch_amt_7)),
#          last_day_rch_amt_8 = as.POSIXct(mdy(last_day_rch_amt_8)))

train <- train %>% 
  mutate(date_of_last_rech_6 = if_else(date_of_last_rech_6 == "", 0, 1),
         date_of_last_rech_7 = if_else(date_of_last_rech_7 == "", 0, 1),
         date_of_last_rech_8 = if_else(date_of_last_rech_8 == "", 0, 1),
         date_of_last_rech_data_6 = if_else(date_of_last_rech_data_6 == "", 0, 1),
         date_of_last_rech_data_7 =if_else(date_of_last_rech_data_7 == "", 0, 1),
         date_of_last_rech_data_8 = if_else(date_of_last_rech_data_8 == "", 0, 1))
...
train_cleaned <- train %>% 
  ...
  # mutate( #xgboost does not allow factors
  #   #circle = as.factor(circle),
  #   fb_user = as.factor(fb_user),
  #   date_of_last_rech_6 = as.factor(date_of_last_rech_6),
  #   date_of_last_rech_7 = as.factor(date_of_last_rech_7),
  #   date_of_last_rech_8 = as.factor(date_of_last_rech_8),
  #   date_of_last_rech_data_6 = as.factor(date_of_last_rech_data_6),
  #   date_of_last_rech_data_7 = as.factor(date_of_last_rech_data_7),
  #   date_of_last_rech_data_8 = as.factor(date_of_last_rech_data_8)
  #   ) %>% 
  select(-id)
...
data_split <- initial_split(train_cleaned, prop = 0.7, strata = churn)
...
set.seed(123)
vb_folds <- vfold_cv(train_data, strata = churn)
...
best_accuracy <- select_best(xgb_res, "accuracy")
